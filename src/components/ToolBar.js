...
class ToolBar extends Component {
      ...
      case "filter":
        Utils.isInEmbed()
          ? this.props.history.replace(
              `/graphs/embed/filter/${graphId}/${token}`
            )
  ...
  render() {
    const { activeButton, singleGraph } = this.props;
      ...
      <div className={`${!showMenu ? "closed_menu" : ""} menu`}>
        <ul className="containerMenu">
          ...
          <li
            ...
            className={`${
              overMenu === "create" || createNewPopup ? "collapse_over" : ""
            } collapse`}
          >
          ...
          <li
            ...
            onMouseLeave={this.handleLeave}
            className={`${
              overMenu === "data_sheet" ? "collapse_over" : ""
            } collapse`}
          >
          ...
          <li
            ...
            onMouseLeave={this.handleLeave}
            className={`${
              overMenu === "analytic" ? "collapse_over" : ""
            } collapse`}
          >
          ...
          <li
            ...
            onMouseLeave={this.handleLeave}
            className={`${
              overMenu === "findNode" ? "collapse_over" : ""
            } collapse`}
          >
          ...
          <Outside onClick={() => this.toggleOutside()}>
            ...
            {showAddNode && (
              <ul className="dropdown-node">
                <li
                  className={`${
                    selected.includes("create-node") ? "selected" : ""
                  }`}
                ...
                <li
                  className={`${
                    selected.includes("linkedIn") ? "selected" : ""
                  }`}
                ...
                <li
                  className={`${
                    selected.includes("wikipedia") ? "selected" : ""
                  }`}
                ...
                <li
                  className={`${
                    selected.includes("sciGraph") ? "selected" : ""
                  }`}
            ...
            {showAddLabel && (
              <ul className="create_label">
                <li
                  ...
                  className={`${
                    selected.includes("freeForm") ? "selected" : ""
                  }`}
                >
                  <FreeForm className="aaa" />
                  <span> Free form </span>
                </li>
                <li
                  onClick={() => this.handleClick("create-label-square")}
                  className={`${
                    selected.includes("create-label-square") ? "selected" : ""
                  }`}
                >
                ...
                <li
                  ...
                  className={`${
                    selected.includes("create-label-ellipse  ")
                      ? "selected"
                      : ""
                  }`}
                >
                  <Ellipse className="aaa" />
                  <span> Ellipse </span>
                </li>
              </ul>
            )}
        ...
        {openHelpsModal && <HelpsModal closeModal={this.closeHelpModal} />}
        <AnalyseModal />
      </div>
    );
  }
