      ...
      <TabPanel>
        ...
        <div className="help_text">
          <ol>
            ...
            <li>Press on the blue cursor to see the cursors of collaborators, who is working on which part of the graph.</li>
      ...
      <TabPanel>
        ...
        <div className="help_text">
          ...
          <ol>
            ...
            <li>The system will automatically compare the graphs and show all similar and different nodes with their quantities. </li>
          </ol>
          <p className="help_node_text">
