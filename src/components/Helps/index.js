...
import Import from "../../assets/images/help/Import.png";
    ...
    <div className="help">
      <Tabs>
        ...
        <TabPanel>
          ...
          <div className="help_text">
            <ol>
              ...
              <li>
                View user’s Info, write Comments, Export in PDF form, and Edit
                the node
              </li>
              <li>
        ...
        <TabPanel>
          ...
          <div className="help_text">
            <ol>
              ...
              <li>
                You have the sections Experience, Education, Skills… mentioned
                in Linkedin profile
              </li>
              <li>
                Click on Add New Tab (+) and enter the information you want
        ...
        <TabPanel>
          ...
          <div className="helpMindText">
            ...
            <a href="www.core.ac.uk">
              {" "}
              <img src={HelpLeftSvg} /> www.core.ac.uk
            </a>
            <a href="www.semanticscholar.org">
              {" "}
              <img src={HelpLeftSvg} /> www.semanticscholar.org
            </a>
            <a href="www.arxiv.org">
              {" "}
              <img src={HelpLeftSvg} /> www.arxiv.org
            </a>
          </div>
          <div className="help_text">
            <ol>
        ...
        <TabPanel>
          ...
          <div>
            ...
            <div className="help_label-text">
              ...
              <li>
                Lock/unlock the Label: Locked Labels are not shown to the
                persons with shared access
              </li>
              <li>
        ...
        <TabPanel>
          ...
          <div className="help_text">
            <p className="marg_graph_text">
              ...
              <br /> Here you can find all listed information about:
            </p>
            <a href="www.core.ac.uk">
              {" "}
              <img src={HelpLeftSvg} /> www.core.ac.uk
          ...
          <div className="help_text">
            ...
            <div className="export_help_text">
              ...
              <a>
                {" "}
                <img src={HelpLeftSvg} /> PNG
              </a>
              <a>
                {" "}
                <img src={HelpLeftSvg} /> PDF
              </a>
              <a>
                {" "}
                <img src={HelpLeftSvg} /> Excel (.xlsx)
              </a>
            </div>
          </div>
          </div>
        ...
        <TabPanel>
          ...
          <div className="help_text">
            ...
            <ol>
              ...
              <li>
                The system will automatically compare the graphs and show all
                similar and different nodes with their quantities.
              </li>
            </ol>
            <p className="help_node_text">
              If you want marge these 2 graphs and make a new graph
              <br /> with similar and different nodes
            </p>
          </div>
          <div className="help_text">
            <ol>
        ...
        <TabPanel>
          ...
          <div>
            <p>
              Compare nodes of a Label/Folder <br /> with the nodes of another
              graph
            </p>
          </div>
          <div className="helpResultText">
        ...
        <TabPanel>
          ...
          <div className="help_text">
            <p className="marg_graph_text">
              ...
              <br /> nodes, appears in the Media gallery.
            </p>
            <ol>
